...
public class RecipeManager extends JavaPlugin
{
	...
	protected void loadSettings()
	{
		...
		net.minecraft.server.v1_5_R1.Item.WATER_BUCKET.a((settings.RETURN_BUCKETS ? net.minecraft.server.v1_5_R1.Item.BUCKET : null));
		net.minecraft.server.v1_5_R1.Item.LAVA_BUCKET.a((settings.RETURN_BUCKETS ? net.minecraft.server.v1_5_R1.Item.BUCKET : null));
		net.minecraft.server.v1_5_R1.Item.MILK_BUCKET.a((settings.RETURN_BUCKETS ? net.minecraft.server.v1_5_R1.Item.BUCKET : null));

		net.minecraft.server.v1_5_R1.Item.MUSHROOM_SOUP.a((settings.RETURN_BOWL ? net.minecraft.server.v1_5_R1.Item.BOWL : null));

		net.minecraft.server.v1_5_R1.Item.POTION.a((settings.RETURN_POTIONS ? net.minecraft.server.v1_5_R1.Item.GLASS_BOTTLE : null));
		net.minecraft.server.v1_5_R1.Item.EXP_BOTTLE.a((settings.RETURN_POTIONS ? net.minecraft.server.v1_5_R1.Item.GLASS_BOTTLE : null));
